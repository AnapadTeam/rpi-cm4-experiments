...
int32_t i2c_write_register_byte(uint32_t i2c_dev_fd, uint16_t slave_address, uint8_t register_address,
...
int32_t i2c_write_register_bytes(uint32_t i2c_dev_fd, uint16_t slave_address, uint8_t register_address,
        uint8_t* register_data, uint16_t register_data_size) {
    uint8_t register_address_data = register_address & 0xFF;
    uint8_t register_write_data[sizeof(register_address_data) + register_data_size];
    memcpy(register_write_data, &register_address_data, sizeof(register_address_data));
    memcpy(register_write_data + sizeof(register_address_data), register_data, register_data_size);
...
int32_t i2c_read_register_byte(uint32_t i2c_dev_fd, uint16_t slave_address, uint8_t register_address) {
...
int32_t i2c_read_register_bytes(uint32_t i2c_dev_fd, uint16_t slave_address, uint8_t register_address,
        uint8_t* register_data, uint16_t register_data_size) {
    uint8_t register_address_data[1] = {register_address & 0xFF};
    ...
    i2c_msgs[1].addr = slave_address;
    i2c_msgs[1].flags = I2C_M_RD; // Read flag
    i2c_msgs[1].len = register_data_size;
